...
<section class="home-grid">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Lisiting Wishlist : <span><?= $total_user_likes; ?></span></p>
         <div class="flex-btn">
            <a href="update.php" class="btn">update profile</a>
        
            <a href="user_likes.php" class="option-btn">Wishlist</a>
         ...
         ?>
            ...
            <div class="flex-btn"> 
               ...
               <a href="register.php" class="option-btn">User Registration</a>
            </div> 
         <?php
          }
         ?>
      ...
      <!-- <div class="box">
         ...
         ?>
            ...
            echo '<p class="empty">no listings added yet!</p>';
         }
         ?>  
...
<section class="posts-container">
   ...
   <div class="more-btn" style="text-align: center; margin-top:1rem;">
      <a href="posts.php" class="inline-btn">view all listings</a>
   </div>
