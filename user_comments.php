...
<section class="comments-container">
   ...
   <p class="comment-title">Comments on Listings</p>
   <div class="user-comments-container">
      ...
      <div class="show-comments">
         ...
         ?>
         <div class="post-title"> from : <span><?= $fetch_posts['title']; ?></span> <a href="view_post.php?post_id=<?= $fetch_posts['id']; ?>" >view listings</a></div>
         <?php
            }
         ?>
