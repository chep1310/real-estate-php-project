...
<section class="posts-container">
   ...
   <h1 class="heading">Whislisted Properties</h1>
   ...
   <div class="box-container">
      ...
      <?php
            ...
            echo '<p class="empty">no properties found for this category!</p>';
         }
         }
      }else{
         echo '<p class="empty">no whislisted properties available!</p>';
      }
      ?>
   </div>
