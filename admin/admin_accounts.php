...
<section class="accounts">
   ...
   <h1 class="heading">Broker Account</h1>

   <div class="box-container">

   <!-- <div class="box" style="order: -2;">
      <p>Register New Author Below</p>
   ...
   <div class="box" style="order: <?php if($fetch_accounts['id'] == $admin_id){ echo '-1'; } ?>;">
      <p> Broker id : <span><?= $fetch_accounts['id']; ?></span> </p>
      <p> Username : <span><?= $fetch_accounts['name']; ?></span> </p>
      <p> Total Property Listed : <span><?= $total_admin_posts; ?></span> </p>
      <div class="flex-btn">
         <?php
