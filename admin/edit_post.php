...
<section class="post-editor">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="title" maxlength="100" required placeholder="Enter Title" class="box" value="<?= $fetch_posts['title']; ?>">
      <p>Property Description <span>*</span></p>
      <textarea name="content" class="box" required maxlength="10000" placeholder="" cols="30" rows="10"><?= $fetch_posts['content']; ?></textarea>
