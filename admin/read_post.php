...
<section class="read-post">
   ...
   <form method="post">
      ...
      <div class="flex-btn">
         ...
         <button type="submit" name="delete" class="inline-delete-btn" onclick="return confirm('delete this listing?');">delete</button>
   ...
   <?php
         ...
         echo '<p class="empty">No Threads Posted! <a href="add_posts.php" class="btn" style="margin-top:1.5rem;">add post</a></p>';
      }
   ?>
