...
<section class="show-posts">
   ...
   <h1 class="heading">Your Lisitngs</h1>
   ...
   <div class="box-container">
      ...
      <form method="post" class="box">
         ...
         <div class="flex-btn">
            ...
            <button type="submit" name="delete" class="delete-btn" onclick="return confirm('Delete this Thread?');">delete</button>
         </div>
         <a href="read_post.php?post_id=<?= $post_id; ?>" class="btn">view listings</a>
      </form>
      <?php
            }
         }else{
            echo '<p class="empty">List Property Below <a href="add_posts.php" class="btn" style="margin-top:1.5rem;">Click here to List property</a></p>';
         }
      ?>
